...
export const projects: Project[] = [
  {
    ...
    description:
      "Nodeself is a behavioral modeling engine. Feed it data in natural language — Nodeself extracts behavioral nodes, builds a causal graph, and models what happens over time. The graph decays when you stop. It simulates your future when you ask.",
    ...
    image: "/images/projects/nodeself.jpg",
    color: "#8b5cf6",
  },
];
