...
void main() {
  ...
  float noise = snoise(pos * uFrequency + uTime * 0.3 + vec3(uMouse * mouseInfluence, 0.0));
...
export default function NoiseSphere({ mouse }: NoiseSphereProps) {
  ...
  useFrame((state) => {
    ...
    uniformsRef.current.uMouse.value.lerp(new THREE.Vector2(mouse.x, mouse.y), 0.05);
